...
class FarmOperatorHomeBody extends StatelessWidget {
  final Size deviceSize;
  final List ctaLists;
  FarmOperatorHomeBody({Key key, @required this.deviceSize, this.ctaLists})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      drawer: CustomDrawer(
        ...
        drawerMenuList: farmOperatorDrawerList(context),
      ),
      body: ListView(
        padding:
