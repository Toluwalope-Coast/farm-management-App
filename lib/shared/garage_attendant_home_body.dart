...
class GarageAttendantHomeBody extends StatelessWidget {
  final Size deviceSize;
  final List ctaLists;
  GarageAttendantHomeBody({Key key, @required this.deviceSize, this.ctaLists})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      drawer: CustomDrawer(
        ...
        drawerMenuList: garageAttendantDrawerList(context),
      ),
      body: ListView(
        padding:
