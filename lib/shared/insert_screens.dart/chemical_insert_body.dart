...
class ChemicalInsertBody extends StatefulWidget {
  ...
  @override
  _ChemicalInsertBodyState createState() => _ChemicalInsertBodyState();
}

class _ChemicalInsertBodyState extends State<ChemicalInsertBody> {
