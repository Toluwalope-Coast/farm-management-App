...
class ExpensesInsertBody extends StatefulWidget {
  ...
  @override
  _ExpensesInsertBodyState createState() => _ExpensesInsertBodyState();
}

class _ExpensesInsertBodyState extends State<ExpensesInsertBody> {
  ...
  Future insertExpenses(context) async {
    DatabaseService firebaseInsertExpense = new DatabaseService();
    try {
      ...
      // dynamic result =
      firebaseInsertExpense.addExpense(expenses);
