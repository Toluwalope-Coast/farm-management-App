...
class TillageInsertBody extends StatefulWidget {
  ...
  @override
  _TillageInsertBodyState createState() => _TillageInsertBodyState();
}

class _TillageInsertBodyState extends State<TillageInsertBody> {
  ...
  Future insertTillage(context) async {
    DatabaseService firebaseInsertTillage = new DatabaseService();
    ...
    try {
      ...
      firebaseInsertTillage.addTillage(tillage);
                    ...
                    child: ListView(
                      children: [
                        ...
                        RoundedFlatButton(
                          ...
                          buttonTextValue: "Insert Tillage",
                          buttonTextStyle: Theme.of(context).textTheme.button,
                          buttonFunction: () => insertTillage(context),
                        ),
                      ],
                    )),
              ),
