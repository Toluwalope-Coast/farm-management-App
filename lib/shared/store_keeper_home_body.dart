...
class StoreKeeperHomeBody extends StatelessWidget {
  final Size deviceSize;
  final List ctaLists;
  StoreKeeperHomeBody({Key key, @required this.deviceSize, this.ctaLists})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      drawer: CustomDrawer(
        ...
        drawerMenuList: storeKeeperDrawerList(context),
      ),
      body: ListView(
        padding:
